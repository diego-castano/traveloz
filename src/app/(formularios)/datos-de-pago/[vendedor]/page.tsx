...
export default async function DatosDePagoPage({
  ...
  if (!formulario.publicado) {
    return (
      <NoDisponible detalle="El formulario de datos de pago todavía no está habilitado. Contacte a su asesor para coordinar el pago por otra vía." />
    );
  }
  ...
  if (!bovedaDisponible()) {
    return (
      <NoDisponible detalle="El formulario de pago no está disponible en este momento. Contacte a su asesor para coordinar el pago por otra vía." />
    );
  }
